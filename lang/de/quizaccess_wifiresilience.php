...
$string['privacy:metadata:quizaccess_wifiresilience_er'] = 'Speichert Notfall-Antwortdateien für Quizversuche, die mit Wifi Resilience verarbeitet werden.';
$string['privacy:metadata:quizaccess_wifiresilience_er:answer_encrypted'] = 'Die verschlüsselten Antworten, die für den Quizversuch der Nutzerin oder des Nutzers gespeichert wurden.';
$string['privacy:metadata:quizaccess_wifiresilience_er:answer_plain'] = 'Die unverschlüsselten Antworten, die für den Quizversuch der Nutzerin oder des Nutzers gespeichert wurden.';
$string['privacy:metadata:quizaccess_wifiresilience_er:attempt'] = 'Die Versuchsnummer der gespeicherten Antwortdatei.';
$string['privacy:metadata:quizaccess_wifiresilience_er:quizid'] = 'Die ID des Quiz, zu dem die gespeicherte Antwortdatei gehört.';
$string['privacy:metadata:quizaccess_wifiresilience_er:timecreated'] = 'Der Zeitpunkt, zu dem die gespeicherte Antwortdatei erstellt wurde.';
$string['privacy:metadata:quizaccess_wifiresilience_er:userid'] = 'Die ID der Nutzerin bzw. des Nutzers, deren bzw. dessen Antwortdatei gespeichert wurde.';
$string['privacy:metadata:quizaccess_wifiresilience_sess'] = 'Speichert aktive Wifi-Resilience-Sitzungen für Quizversuche.';
$string['privacy:metadata:quizaccess_wifiresilience_sess:attemptid'] = 'Die ID des Quizversuchs, der zur aktiven Sitzung gehört.';
$string['privacy:metadata:quizaccess_wifiresilience_sess:sesskey'] = 'Der Sitzungsschlüssel der aktiven Wifi-Resilience-Sitzung.';
$string['privacy:metadata:quizaccess_wifiresilience_sess:userid'] = 'Die ID der Nutzerin bzw. des Nutzers, die bzw. der zur aktiven Sitzung gehört.';
