...
$string['privacy:metadata:quizaccess_wifiresilience_er'] = 'Stores emergency response files for quiz attempts handled by Wifi Resilience.';
$string['privacy:metadata:quizaccess_wifiresilience_er:answer_encrypted'] = 'The encrypted answers stored for the user\'s quiz attempt.';
$string['privacy:metadata:quizaccess_wifiresilience_er:answer_plain'] = 'The plain-text answers stored for the user\'s quiz attempt.';
$string['privacy:metadata:quizaccess_wifiresilience_er:attempt'] = 'The attempt number associated with the stored response file.';
$string['privacy:metadata:quizaccess_wifiresilience_er:quizid'] = 'The ID of the quiz the stored response file belongs to.';
$string['privacy:metadata:quizaccess_wifiresilience_er:timecreated'] = 'The time when the stored response file was created.';
$string['privacy:metadata:quizaccess_wifiresilience_er:userid'] = 'The ID of the user whose response file was stored.';
$string['privacy:metadata:quizaccess_wifiresilience_sess'] = 'Stores active Wifi Resilience sessions for quiz attempts.';
$string['privacy:metadata:quizaccess_wifiresilience_sess:attemptid'] = 'The ID of the quiz attempt associated with the active session.';
$string['privacy:metadata:quizaccess_wifiresilience_sess:sesskey'] = 'The session key stored for the active Wifi Resilience session.';
$string['privacy:metadata:quizaccess_wifiresilience_sess:userid'] = 'The ID of the user associated with the active session.';
